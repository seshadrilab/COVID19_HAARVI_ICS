...
# CohortColors <- c("Hospitalized" = "#083b31", "Non-hospitalized" = "#018571", "Healthy" = "#80cdc1") # shades of green
# CohortColors <- c("Hospitalized" = "#9da4ce", "Non-hospitalized" = "#c1ddd7", "Healthy" = "#ebeef0") # pastel periwinkle and green
# CohortColors <- c("Hospitalized" = "#707ed4", "Non-hospitalized" = "#69c2af", "Healthy" = "#ebeef0") # darker shades
# CohortColors <- c("Hospitalized" = "#00579A", "Non-hospitalized" = "#A0C78F", "Healthy" = "#ebeef0") # blue and green
CohortColors <- c("Hospitalized" = "#386cb0", "Non-hospitalized" = "#7fc97f", "Healthy" = "#ebeef0") # blue and green darker    https://colorbrewer2.org/?type=qualitative&scheme=Accent&n=6
