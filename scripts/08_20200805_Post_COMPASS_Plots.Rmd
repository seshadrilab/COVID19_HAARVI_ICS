...
fs_vs_x_plot("4", "N")
fs_vs_x_plot("4", "E")
fs_vs_x_plot("4", "E", include_regression_line = F)
fs_vs_x_plot("8", "S1")
fs_vs_x_plot("8", "S2")
fs_vs_x_plot("8", "N")
fs_vs_x_plot("8", "E")
fs_vs_x_plot("8", "E", include_regression_line = F)
```
...
fs_vs_x_plot("4", "E", xaxis="Days_Symptom_Onset_to_Visit_1", include_regression_line = F)
...
fs_vs_x_plot("8", "E", xaxis="Days_Symptom_Onset_to_Visit_1", include_regression_line = F)
```
