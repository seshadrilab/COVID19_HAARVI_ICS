...
ifng_stratified_plots$`8_Spike_2`$data_long %>% dplyr::filter(BgCorr_Prop_Sum > 0.005)
ifng_stratified_plots$`8_NCAP`$data_long %>% dplyr::filter(BgCorr_Prop_Sum > 0.0045)
```
