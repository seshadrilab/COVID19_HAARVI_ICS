...
xml_path_b1 <- here::here("data/20200528_COVID_ICS-B1_CS.xml")
...
# So, use SAMPLE ID moving forward
...
save_gs(gs_b1, here::here("out/GatingSets/20200529_HAARVI_ICS_GatingSet_B1"))
...
# write.table(rcd1b_gmm_counts, here::here("out/Statistics_Plots/20200318_rCD1b_GMM_Counts.tsv"), sep = "\t", row.names = F)
# cd1c_panel_counts <- read.table(here::here("out/Statistics_Plots/20200318_rCD1c_GMM_rMR1_hCD1d_CD69TEM_Counts.tsv"), sep = "\t", header=T)
